                        ...
                        <div class='valores2'>
                          <div class='letras'>
                            <div class='doistiposletras'>
                              <h1 class='titulosletrasvalores'>FRETE GRÁTIS - MOOVE</h1>
                              <p class='titulosletrasvaloresp'>Chega entre sexta 08/12 e quarta 13/12</p>
                            </div>
                          </div>
                          <div class='valor'>
                              <h1 class='valorletra4'>Grátis</h1>
                          </div>
                        </div>
                    </div>
                    <div class='frete2'>
                      ...
                      <div class='valores2'>
                          <div class='letras'>
                            <div class='doistiposletras'>
                              ...
                              <p class='titulosletrasvaloresp'>Chega entre segunda 11/12 e terça 19/12</p>
                            </div>
                            </div>
                            <div class='valor'>
                  ...
                  <br>
                    <div class='tudo-dentro'>
                      ...
                      <div class='paidescrisao'>
                        <div class='descricao'>
                          <p>Você está prestes a adquirir um produto totalmente único e de qualidade.</p>
                          </br>
                          <p>Nosso moletom é flanelado por dentro, por isso é muito mais quentinho e fofo, é uma peça de extrema qualidade, proporcionando conforto e estilo para te aquecer nesse inverno. Os moletons são unissex, assim todos podem ficar quentinhos e formidáveis!</p>
                          </br>
                          <p>Nossas estampas (formidáveis, é claro) são criadas e pensadas especialmente pra você, o processo de produção silkscreen é feito à base d'água (o que faz com que sua estampa nunca corra o risco de craquelar).</p>                      
                          </br>
                          <p>O prazo de envio é de 15 (quinze) a 20 (vinte) dias úteis, não incluso o prazo dos correios ou transportadora. Esse prazo é referente à confecção e embalagem dos produtos.</p>
                        </div>
                      </div>
                  </div>
            </div>
