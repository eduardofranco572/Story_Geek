    ...
    <div class='tudo'>
      <?php 
        ...
        echo "
            ...
            <br>
            <br>
            <form enctype='multipart/form-data' class='formdoido' method='post' action='sqlmudar.php'>
              <div class='form-dentro'>
                <h1 class='nomes-input'>ID DO PRODUTO</h1>
                <input class='intp' type='text' name='ID' size='25' value='$ID' /><br />
                <br />
                <h1 class='nomes-input'>NOME DO PRODUTO</h1>
                <input class='intp' type='text' name='nome' size='25' value='$nome' /><br />
                <br />
                <h1 class='nomes-input'>MODELO</h1>
                <input class='intp' type='text' name='modelo' size='25' value='$modeleo' /><br />
                <br />
                <h1 class='nomes-input'>VALOR DO PRODUTO</h1>
                <input class='intp' type='text' name='valor' size='25' value='$valor' /><br />
                <br/>
              </div>
              <div class='imgs'>
                <div class='img1-div'>
                  <h1 class='nomes-input'>IMAGEM 1</h1>
                  <input id='img-input' type='file' name='img1' size='25' style='border-radius: 0px;'/><br />
                  <div class='contenerimg' id='img-container'>
                    <img id='preview' src='../upload/produto/".$img1."' >
                  </div>
                </div>
                <br/>
                <div class='img2-div'>
                  <h1 class='nomes-input'>IMAGEM 2</h1>
                  <input id='img-input2' type='file' name='img2' size='25' style='border-radius: 0px;' /><br />
                  <div class='contenerimg' id='img-container2'>
                    <img id='preview2' src='../upload/produto/".$img2."'>
                  </div>
                </div>
                <br/>
                <div class='img3-div'>
                  <h1 class='nomes-input'>IMAGEM 3</h1>
                  <input id='img-input3' type='file' name='img3' size='25' style='border-radius: 0px;' /><br />
                  <div class='contenerimg' id='img-container3'>
                    <img id='preview3' src='../upload/produto/".$img3."'>
                </div>
                <br/>
                <div class='img4-div'>
                  <h1 class='nomes-input'>IMAGEM 4</h1>
                  <input id='img-input4' type='file' name='img4' size='25' style='border-radius: 0px;' /><br />
                  <div class='contenerimg' id='img-container4'>
                    <img id='preview4' src='../upload/produto/".$img4."'>
                  </div>
                </div>
                <br/>
                <div class='img5-div'>
                  <h1 class='nomes-input'>IMAGEM 5</h1>
                  <input id='img-input5' type='file' name='img5' size='25' style='border-radius: 0px;' /><br />
                  <div class='contenerimg' id='img-container5'>
                    <img id='preview5' src='../upload/produto/".$img5."'>
                  </div>
                </div>
                <br/>
                </div>
                </div>
                <input class='cadastar' type='submit' name='enviar' value='ALTERAR PRODUTO' />
              </div>
            </form>
            <br>
          ";
